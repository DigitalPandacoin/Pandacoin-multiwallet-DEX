...
# Qt
sudo apt-get install qtbase5-dev qtdeclarative5-dev qttools5-dev libqt5svg5-dev libqt5charts5-dev qtwebengine5-dev qtquickcontrols2-5-dev libqt5waylandclient5-dev -y
...
# sudo apt-get dist-upgrade -t noble-backports -y
