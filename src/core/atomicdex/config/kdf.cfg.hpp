...
namespace atomic_dex
{
    ...
    struct kdf_config
    {
        ...
        std::vector<std::string> seednodes{"seed01.kmdefi.net", "seed02.kmdefi.net", "balerion.dragon-seed.com", "falkor.dragon-seed.com", "drogon.dragon-seed.com", "heeby.dragon-seed.com", "smaug.dragon-seed.com", "tintaglia.dragon-seed.com", "viserion.dragon-seed.com"};
#ifdef _WIN32
